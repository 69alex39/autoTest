...
def test_positive_login():
    ...
    email.click()
    email.send_keys('a3a69@yandex.ru') # введи тут email своего тестового аккаунта на stage окружении
    ...
    password.click()
    password.send_keys('Asa151001') # введи тут пароль своего тестового аккаунта на stage окружении
    ...
    assert trainer_id.text.replace('\n', ': ') == 'ID: 1058', 'Unexpected ID trainer' # введи тут ID своего тренера